...
public class UpdateAllowList extends AbstractServiceDelegate implements InitializingBean
{
	...
	public void doExecute(DelegateExecution execution) throws Exception
	{
		...
		IdType result = client.withMinimalReturn().updateConditionaly(transaction, Map.of("identifier", Collections
				.singletonList(ConstantsUpdateAllowList.CODESYSTEM_HIGHMED_UPDATE_ALLOW_LIST + "|"
	...
	{
		return ept.getIdentifier().stream()
				.filter(i -> ConstantsBase.NAMINGSYSTEM_HIGHMED_ENDPOINT_IDENTIFIER.equals(i.getSystem())).findFirst();
	}
