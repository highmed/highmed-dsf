...
public interface Constants
{
	...
	String VARIABLE_LEADING_TASK = "leading-task";
	...
	String VARIABLE_QUERY_RESULT = "queryResult";
	String VARIABLE_COHORT_SIZE_RESULTS = "cohortSizeResults";
	String VARIABLE_MULTI_MEDIC_COHORT_SIZE_RESULT = "multiMedicCohortSizeResult";
	String VARIABLE_MULTI_MEDIC_PARTICIPATION_RESULT = "multiMedicParticipationResult";
	String VARIABLE_PROCESS_OUTPUTS = "outputs"; // stores Optional<Map<String, String>>
	...
	String CODESYSTEM_HIGHMED_BPMN_VALUE_SIMPLE_COHORT_SIZE_QUERY_RESULT = "simple-cohort-size-query-result";
	String CODESYSTEM_HIGHMED_BPMN_VALUE_PARTICIPATION_RESULT = "participating-medics-result";
