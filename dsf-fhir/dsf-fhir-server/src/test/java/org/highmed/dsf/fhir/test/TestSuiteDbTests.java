...
import org.highmed.dsf.fhir.dao.ActivityDefinitionDaoTest;
...
@RunWith(Suite.class)
@SuiteClasses({ ActivityDefinitionDaoTest.class, BinaryDaoTest.class, BundleDaoTest.class, CodeSystemDaoTest.class,
		EndpointDaoTest.class, GroupDaoTest.class, HealthcareServiceDaoTest.class, LocationDaoTest.class,
