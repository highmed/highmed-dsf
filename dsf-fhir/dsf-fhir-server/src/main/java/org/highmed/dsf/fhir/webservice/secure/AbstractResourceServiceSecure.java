...
public abstract class AbstractResourceServiceSecure<R extends Resource, S extends BasicResourceService<R>>
		extends AbstractServiceSecure<S> implements BasicResourceService<R>
{
	...
	public AbstractResourceServiceSecure(S delegate, ResponseGenerator responseGenerator)
	{
