...
public class StructureDefinitionStatus extends AbstractTokenParameter<StructureDefinition>
{
	...
	public boolean matches(Resource resource)
	{
		...
		return Objects.equals(((StructureDefinition) resource).getStatus(), status);
	}
