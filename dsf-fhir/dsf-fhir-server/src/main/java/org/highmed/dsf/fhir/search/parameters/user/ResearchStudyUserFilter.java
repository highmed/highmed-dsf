...
{
	private static final Logger logger = LoggerFactory.getLogger(ResearchStudyUserFilter.class);

	public ResearchStudyUserFilter(OrganizationType organizationType, User user)
	{
