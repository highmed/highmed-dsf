...
{
	private static final Logger logger = LoggerFactory.getLogger(PractitionerUserFilter.class);

	public PractitionerUserFilter(OrganizationType organizationType, User user)
	{
