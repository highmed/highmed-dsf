...
public class ExceptionHandler
{
	...
	{
		logger.error(resourceTypeName + " with id {} not found", e.getId());
	...
	{
		logger.error(resourceTypeName + " with id (not a UUID) not found");
	...
	{
		logger.error(resourceTypeName + " with id {} is marked as deleted", e.getId());
